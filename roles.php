...
?>
    ...
    <div class="container">
        ...
        <div class="form">
            ...
            <form action="verroles.php" method="post">
                ...
                <div class="input-group">
                    <div class="input-box">
                        ...
                        <input id="nombre" type="text" name="nombre" placeholder="Digite su Rol" required>
                    </div>
           ...
           <br>
			...
			<button type="button" class="btn btn-secondary" onclick="window.location.href='registroles.php'" id="myModal">Ver Roles</button>
